...
See the doc on
[extending grid Sensors](https://github.com/Unity-Technologies/ml-agents/blob/release_23_docs/com.unity.ml-agents.extensions/Documentation~/CustomGridSensors.md)
