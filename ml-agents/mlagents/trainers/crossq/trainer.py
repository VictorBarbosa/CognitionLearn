...
from mlagents.trainers.crossq.optimizer_torch import (
    TorchCrossQOptimizer,
    CrossQSettings,
)  
...
class CrossQTrainer(OffPolicyTrainer):
    """
    The CrossQTrainer is an implementation of the CrossQ algorithm.
    """
    ...
    def __init__(
        ...
        """
        Responsible for collecting experiences and training CrossQ model.
        ...
        self.optimizer: TorchCrossQOptimizer = None  # type: ignore
        self.hyperparameters: CrossQSettings = cast(
            CrossQSettings, trainer_settings.hyperparameters
        )
        self._step = 0
    ...
    def create_optimizer(self) -> TorchOptimizer:
        return TorchCrossQOptimizer(  # type: ignore
    ...
    def create_policy(
        ...
        """
        Creates a policy with a PyTorch backend and CrossQ hyperparameters
