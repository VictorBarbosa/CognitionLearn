...
# ## ML-Agent Learning (MASAC)
# Contains an implementation of MASAC as described in https://arxiv.org/abs/1801.01290
# and implemented in https://github.com/hill-a/stable-baselines, with a centralized critic.
...
from mlagents.trainers.masac.optimizer_torch import TorchMASACOptimizer, MASACSettings
...
class MASACTrainer(OffPolicyTrainer):
    """
    The MASACTrainer is an implementation of the MASAC algorithm.
    """
    ...
    def __init__(
        ...
        """
        Responsible for collecting experiences and training MASAC model.
        ...
        self.optimizer: TorchMASACOptimizer = None  # type: ignore
        self.hyperparameters: MASACSettings = cast(
            MASACSettings, trainer_settings.hyperparameters
        )
        self._step = 0
    ...
    def create_optimizer(self) -> TorchOptimizer:
        return TorchMASACOptimizer(  # type: ignore
    ...
    def create_policy(
        ...
        """
        Creates a policy with a PyTorch backend and MASAC hyperparameters
