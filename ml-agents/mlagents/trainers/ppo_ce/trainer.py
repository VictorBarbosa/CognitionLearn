...
# ## ML-Agent Learning (PPO-CE)
# Contains an implementation of PPO with Curiosity Exploration.
...
from mlagents.trainers.ppo_ce.optimizer_torch import TorchPPOCEOptimizer, PPOCESettings
...
class PPOCETrainer(OnPolicyTrainer):
    """The PPOCETrainer is an implementation of the PPO algorithm with Curiosity Exploration."""
    ...
    def __init__(
        ...
        """
        Responsible for collecting experiences and training PPO-CE model.
        ...
        self.hyperparameters: PPOCESettings = cast(
            PPOCESettings, self.trainer_settings.hyperparameters
        )
        self.seed = seed
    ...
    def create_optimizer(self) -> TorchOptimizer:
        return TorchPPOCEOptimizer(  # type: ignore
    ...
    def create_policy(
        ...
        """
        Creates a policy with a PyTorch backend and PPO-CE hyperparameters
