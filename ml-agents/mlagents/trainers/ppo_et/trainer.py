...
# ## ML-Agent Learning (PPO-ET)
# Contains an implementation of PPO with Entropy Temperature control.
...
from mlagents.trainers.ppo_et.optimizer_torch import TorchPPOETOptimizer, PPOETSettings
...
class PPOETTrainer(OnPolicyTrainer):
    """The PPOETTrainer is an implementation of the PPO algorithm with Entropy Temperature control."""
    ...
    def __init__(
        ...
        """
        Responsible for collecting experiences and training PPO-ET model.
        ...
        self.hyperparameters: PPOETSettings = cast(
            PPOETSettings, self.trainer_settings.hyperparameters
        )
        self.seed = seed
    ...
    def create_optimizer(self) -> TorchOptimizer:
        return TorchPPOETOptimizer(  # type: ignore
    ...
    def create_policy(
        ...
        """
        Creates a policy with a PyTorch backend and PPO-ET hyperparameters
