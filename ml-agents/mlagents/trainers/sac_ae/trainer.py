# ## ML-Agent Learning (SAC-AE)
# Contains an implementation of SAC-AE as described in the SAC-AE documentation.
...
from mlagents.trainers.sac_ae.optimizer_torch import TorchSACAEOptimizer, SACAESettings
...
class SACAETrainer(OffPolicyTrainer):
    """
    The SACAETrainer is an implementation of the SAC-AE algorithm, with support
    ...
    def __init__(
        ...
        """
        Responsible for collecting experiences and training SAC-AE model.
        ...
        self.optimizer: TorchSACAEOptimizer = None  # type: ignore
    ...
    def create_optimizer(self) -> TorchOptimizer:
        return TorchSACAEOptimizer(  # type: ignore
    ...
    def create_policy(
        ...
        """
        Creates a policy with a PyTorch backend and SAC-AE hyperparameters
