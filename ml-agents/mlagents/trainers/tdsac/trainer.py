...
# ## ML-Agent Learning (TDSAC)
# Contains an implementation of TDSAC as described in https://arxiv.org/abs/1802.09477
...
from mlagents.trainers.tdsac.optimizer_torch import TorchTDSACOptimizer, TDSACSettings
...
class TDSACTrainer(OffPolicyTrainer):
    """
    The TDSACTrainer is an implementation of the TDSAC algorithm.
    """
    ...
    def __init__(
        ...
        """
        Responsible for collecting experiences and training TDSAC model.
        ...
        self.optimizer: TorchTDSACOptimizer = None  # type: ignore
        self.hyperparameters: TDSACSettings = cast(
            TDSACSettings, trainer_settings.hyperparameters
        )
        self._step = 0
    ...
    def create_optimizer(self) -> TorchOptimizer:
        return TorchTDSACOptimizer(  # type: ignore
    ...
    def create_policy(
        ...
        """
        Creates a policy with a PyTorch backend and TDSAC hyperparameters
